package com.chriscorp.celer.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.chriscorp.celer.model.BitchatFilePacket
    ): String {
     ...
     */
    fun messageTypeForMime(mime: String): com.chriscorp.celer.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.chriscorp.celer.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.chriscorp.celer.model.BitchatMessageType.Audio
            else -> com.chriscorp.celer.model.BitchatMessageType.File
        }
    }
}
