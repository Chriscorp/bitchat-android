...
import com.chriscorp.celer.onboarding.BluetoothCheckScreen
import com.chriscorp.celer.onboarding.BluetoothStatus
import com.chriscorp.celer.onboarding.BluetoothStatusManager
import com.chriscorp.celer.onboarding.BatteryOptimizationManager
import com.chriscorp.celer.onboarding.BatteryOptimizationPreferenceManager
import com.chriscorp.celer.onboarding.BatteryOptimizationScreen
import com.chriscorp.celer.onboarding.BatteryOptimizationStatus
import com.chriscorp.celer.onboarding.InitializationErrorScreen
import com.chriscorp.celer.onboarding.InitializingScreen
import com.chriscorp.celer.onboarding.LocationCheckScreen
import com.chriscorp.celer.onboarding.LocationStatus
import com.chriscorp.celer.onboarding.LocationStatusManager
import com.chriscorp.celer.onboarding.OnboardingCoordinator
import com.chriscorp.celer.onboarding.OnboardingState
import com.chriscorp.celer.onboarding.PermissionExplanationScreen
import com.chriscorp.celer.onboarding.PermissionManager
import com.chriscorp.celer.ui.ChatScreen
import com.chriscorp.celer.ui.ChatViewModel
import com.chriscorp.celer.ui.theme.CelerTheme
import com.chriscorp.celer.nostr.PoWPreferenceManager
...
class MainActivity : ComponentActivity() {
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.chriscorp.celer.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.chriscorp.celer.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.chriscorp.celer.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.chriscorp.celer.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.chriscorp.celer.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.chriscorp.celer.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.chriscorp.celer.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.chriscorp.celer.geohash.GeohashChannelLevel.CITY
                        4 -> com.chriscorp.celer.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.chriscorp.celer.geohash.GeohashChannelLevel.REGION
                        else -> com.chriscorp.celer.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.chriscorp.celer.geohash.GeohashChannel(level, geohash)
                    val channelId = com.chriscorp.celer.geohash.ChannelID.Location(geohashChannel)
