package com.chriscorp.celer.ui
...
import com.chriscorp.celer.mesh.BluetoothMeshDelegate
import com.chriscorp.celer.mesh.BluetoothMeshService
import com.chriscorp.celer.model.BitchatMessage
import com.chriscorp.celer.model.BitchatMessageType
import com.chriscorp.celer.protocol.BitchatPacket


import kotlinx.coroutines.launch
import com.chriscorp.celer.util.NotificationIntervalManager
...
class ChatViewModel(
    ...
    private val debugManager by lazy { try { com.chriscorp.celer.ui.debug.DebugSettingsManager.getInstance() } catch (e: Exception) { null } }
    ...
    val selectedLocationChannel: LiveData<com.chriscorp.celer.geohash.ChannelID?> = state.selectedLocationChannel
    ...
    init {
        ...
        viewModelScope.launch {
            com.chriscorp.celer.mesh.TransferProgressManager.events.collect { evt ->
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            com.chriscorp.celer.ui.debug.DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (com.chriscorp.celer.ui.debug.DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
                    ...
                    if (selectedLocation is com.chriscorp.celer.geohash.ChannelID.Mesh) {
        ...
        com.chriscorp.celer.favorites.FavoritesPersistenceService.initialize(getApplication())


        // Ensure NostrTransport knows our mesh peer ID for embedded packets
        try {
            val nostrTransport = com.chriscorp.celer.nostr.NostrTransport.getInstance(getApplication())
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as com.chriscorp.celer.nostr.GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as com.chriscorp.celer.nostr.NostrSubscriptionManager
                val identity = com.chriscorp.celer.nostr.NostrIdentityBridge.deriveIdentity(gh, getApplication())
                val subId = "geo-dm-$gh"
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as com.chriscorp.celer.nostr.NostrDirectMessageHandler
    ...
    fun startPrivateChat(peerID: String) {
        ...
        if (success) {
            ...
            try {
                val seen = com.chriscorp.celer.services.SeenMessageStore.getInstance(getApplication())
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = com.chriscorp.celer.services.ConversationAliasResolver.resolveCanonicalPeerID(
                    ...
                    nostrPubHexForAlias = { alias -> com.chriscorp.celer.nostr.GeohashAliasRegistry.get(alias) },
                    findNoiseKeyForNostr = { key -> com.chriscorp.celer.favorites.FavoritesPersistenceService.shared.findNoiseKey(key) }
                )
                canonical ?: targetKey
            }
    ...
    fun sendMessage(content: String) {
        ...
        if (content.startsWith("/")) {
            ...
            commandProcessor.processCommand(content, meshService, meshService.myPeerID, { messageContent, mentions, channel ->
                if (selectedLocationForCommand is com.chriscorp.celer.geohash.ChannelID.Location) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = com.chriscorp.celer.services.ConversationAliasResolver.resolveCanonicalPeerID(
            ...
            privateChatManager.sendPrivateMessage(
                ...
                val router = com.chriscorp.celer.services.MessageRouter.getInstance(getApplication(), meshService)
                router.sendPrivate(messageContent, peerID, recipientNicknameParam, messageId)
            }
        } else {
            // Check if we're in a location channel
            val selectedLocationChannel = state.selectedLocationChannel.value
            if (selectedLocationChannel is com.chriscorp.celer.geohash.ChannelID.Location) {
    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (peerInfo?.noisePublicKey != null) {
                ...
                if (peerID.length == 64 && peerID.matches(Regex("^[0-9a-fA-F]+$"))) {
                    try {
                        ...
                        val rel = com.chriscorp.celer.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey!!)
            ...
            if (noiseKey != null) {
                ...
                val identityManager = com.chriscorp.celer.identity.SecureIdentityStateManager(getApplication())
                ...
                com.chriscorp.celer.favorites.FavoritesPersistenceService.shared.updateFavoriteStatus(
                ...
                try {
                    val myNostr = com.chriscorp.celer.nostr.NostrIdentityBridge.getCurrentNostrIdentity(getApplication())
    ...
    private fun updateReactiveStates() {
        ...
        sessionStates.forEach { (peerID, newState) ->
            ...
            if (old != "established" && newState == "established") {
                com.chriscorp.celer.services.MessageRouter
    ...
    fun panicClearAllData() {
        ...
        try {
            ...
            try {
                val store = com.chriscorp.celer.geohash.GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }
    ...
    private fun clearAllCryptographicData() {
        try {
            ...
            try {
                com.chriscorp.celer.favorites.FavoritesPersistenceService.shared.clearAllFavorites()
    ...
    fun selectLocationChannel(channel: com.chriscorp.celer.geohash.ChannelID) {
