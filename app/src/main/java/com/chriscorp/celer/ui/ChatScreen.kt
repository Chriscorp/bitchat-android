...
import com.chriscorp.celer.ui.media.FullScreenImageViewer
...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    val displayMessages = when {
        ...
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.chriscorp.celer.geohash.ChannelID.Location) {
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.chriscorp.celer.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.chriscorp.celer.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
...
private fun ChatDialogs(
    ...
    if (showDebugSheet) {
        com.chriscorp.celer.ui.debug.DebugSettingsSheet(
