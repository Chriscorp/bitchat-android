...
class ChatState {
    ...
    private val _selectedLocationChannel = MutableLiveData<com.chriscorp.celer.geohash.ChannelID?>(com.chriscorp.celer.geohash.ChannelID.Mesh)
    val selectedLocationChannel: LiveData<com.chriscorp.celer.geohash.ChannelID?> = _selectedLocationChannel
    ...
    fun setSelectedLocationChannel(channel: com.chriscorp.celer.geohash.ChannelID?) {
