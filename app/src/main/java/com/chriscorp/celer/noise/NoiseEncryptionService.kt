package com.chriscorp.celer.noise

import android.content.Context
import android.util.Log
import com.chriscorp.celer.identity.SecureIdentityStateManager
import com.chriscorp.celer.mesh.PeerFingerprintManager
import com.chriscorp.celer.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.chriscorp.celer.noise.southernstorm.protocol.Noise.createDH("25519")
     ...
     */
    fun signPacket(packet: com.chriscorp.celer.protocol.BitchatPacket): com.chriscorp.celer.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.chriscorp.celer.protocol.BitchatPacket, publicKey: ByteArray): Boolean {
